odoo.define('helpdesk_mexico.dashboard', function (require) {
"use strict";
...
var HelpdeskDashboardRenderer = KanbanRenderer.extend({
    ...
    _render: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var helpdesk_dashboard = QWeb.render('helpdesk_mexico.HelpdeskDashboard2', {
                widget: self,
...
view_registry.add('helpdesk_dashboard2', HelpdeskDashboardView);
