...
class WebsiteForm(WebsiteForm):
    ...
    def website_helpdesk_form(self, team, **kwargs):
        ...
        group_ids = request.env['res.users'].sudo().search([('id','=',user.id)]).group_companys_id
        ...
        default_values['ticket_type_ids'] = ticket_type_ids
        default_values['group_ids'] = group_ids
